          ...
          <>
            ...
            <ModalBody>
              ...
              <div className='sm:px-6 px-4 sm:pt-6 sm:pb-8 py-4 flex sm:flex-row flex-col relative z-20 gap-4'>
                <Facebook className='size-12 flex-none' />
                <div className='flex flex-col max-w-[100%] sm:w-full'>
                  <h1 className='text-gray-900 font-semibold text-lg'>Generate Next Facebook Task?</h1>
                  <p className='font-normal text-sm text-gray-600'>Are you sure you want to generate your next Facebook task now. You have 1 hour to perform this task. Please confirm only if you are ready to perform the task.</p>
                </div>
              </div>
            </ModalBody>
            <ModalFooter>
