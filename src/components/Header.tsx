...
export default function Header({ openDrawer, setOpenDrawer }: header_types) {
  return (
    <header className='w-full flex flex-none sticky z-20 backdrop-blur-lg backdrop-saturate-150 bg-neutral-100/70 top-0 2xl:px-8 sm:px-6 2xl:py-8 sm:py-6 px-4 py-4 justify-between items-center'>
      <div className='h-full items-center flex gap-x-4'>
        <div onClick={() => setOpenDrawer(true)} className='lg:hidden cursor-pointer flex'>
