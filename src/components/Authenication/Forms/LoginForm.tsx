    ...
    return (
        <form className="flex flex-col items-center w-full justify-center pt-10 sm:pt-24 font-redHat gap-y-6">
            ...
            <div className="flex flex-col items-center gap-y-4 w-full">
                ...
                <div className="w-full flex justify-center">
                    <InputField type="password" placeholder="Enter your password" leftIcon="invisible" className="w-10/12 sm:w-[440px] border-[1px] border-solid border-inputBorder py-2 rounded-md pl-4 text-medium flex items-center"/>
                </div>
            </div>
