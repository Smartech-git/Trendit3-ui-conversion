...
export default function GenericTask({ data, type }: { data?: any; type?: "createAd" | "earn" }) {
  ...
  return (
    ...
    <div className='w-full flex flex-col overflow-hidden rounded shadow-main border border-neutral-100 bg-white'>
